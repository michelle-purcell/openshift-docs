...
= About {rhl-advisor} for {product-title}

[role="_abstract"]
You can use the {rhl-advisor-service} to assess and monitor the health of your {product-title} clusters. Whether you are concerned about individual clusters, or with your whole infrastructure, it is important to be aware of the exposure of your cluster infrastructure to issues that can affect service availability, fault tolerance, performance, or security.
...
The results of the {red-hat-lightspeed} analysis are available in the {rhl-advisor-service} on {hybrid-console}. In the {hybrid-console}, you can perform the following actions:
