...
[role="_abstract"]
You can view the time it takes for the {insights-operator} to gather the information contained in the archive. This helps you to understand {insights-operator} resource usage and issues with {rhl-advisor}.
