...
[role="_abstract"]
This section describes how to display the {red-hat-lightspeed} report in *{rhl-advisor}* on {cluster-manager-url}.
...
+
Depending on the result, the {rhl-advisor-service} displays one of the following:
+
