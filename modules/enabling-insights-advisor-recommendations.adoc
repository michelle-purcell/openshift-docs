...
= Enabling a previously disabled {rhl-advisor-service} recommendation

[role="_abstract"]
When a recommendation is disabled for all clusters, you no longer see the recommendation in the {rhl-advisor-service}. You can change this behavior.
